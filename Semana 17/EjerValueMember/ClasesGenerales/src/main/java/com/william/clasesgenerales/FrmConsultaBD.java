...
public class FrmConsultaBD extends javax.swing.JFrame {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(cbxMateria, javax.swing.GroupLayout.Alignment.LEADING, 0, 325, Short.MAX_VALUE)))
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        es.setFechadeNcimiento(jDateChooser1.getDate());
        es.setUsername("vacio");
        es.setPasswordUser("vacio");
        estudiantes.AddEstudiante(es);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        Nota nota = new Nota();
        Notas nDAO = new Notas();
        
        nota.setNota(txtNota.getText());
        nota.setFkMateria(idMateria[cbxMateria.getSelectedIndex()]);
        nota.setFkEstudiante(id[cbEstu.getSelectedIndex()]);
        nDAO.AgregarNota(nota);
        
        
//        int idcombo = id[cbEstu.getSelectedIndex()];
//        JOptionPane.showMessageDialog(null, idcombo);
    ...
    public void cargar() {
        ...
        for (var iteracion : es.ListadoEstudiantesConNotas()) {
            ///  ListM estBucle = (ListM) iterador.next();
    ...
    public void CargarCbxMateria(){
            ...
            ArrayList<Materia> ListM = materiaDAO.ListadoM();
            Iterator iterator = ListM.iterator();
            DefaultComboBoxModel DefaultComboBoxModel = new DefaultComboBoxModel();
            DefaultComboBoxModel.removeAllElements();
            cbEstu.removeAll();
            String filas[] = new String[3];
             idMateria= new int[ListM.size()];
            ...
            while (iterator.hasNext()) {
                ...
                idMateria[intContador] = materia.getIdMateria();
                 
                DefaultComboBoxModel.addElement(materia.getNombreMateria());
                intContador++;
           
            }
            cbxMateria.setModel(DefaultComboBoxModel);
    }
    /**
